namespace :db do
  desc "Add marketplace category and items to all stores"
  task add_marketplace: :environment do
    puts "🛒 Adding MARKETPLACE category to all stores..."
    ...
    puts "✨ Marketplace setup complete!"
  end
end
